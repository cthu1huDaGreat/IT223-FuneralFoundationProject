...
<link rel="stylesheet" href="{{url('css/dashboard-treasurer.css')}}">
...
<aside class="sidebar" id="sidebar">
  ...
  <nav>
    <a href="{{route('page.dashboard-treasurer')}}" class="active">Dashboard</a>
    <a href="{{route('page.treasurer-contributions')}}">Transactions</a>
...
function createAttendanceCard(record, isArchived) {
    ...
    function updateAttendanceStatus(attendanceId, userId, status) {
        fetch('{{ route("attendance.updateStatus") }}', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '{{ csrf_token() }}',
    ...
    function archiveAttendance(attendanceId) {
        fetch('{{ route("attendance.archive") }}', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '{{ csrf_token() }}',
