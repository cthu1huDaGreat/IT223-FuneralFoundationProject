...
<link rel="stylesheet" href="{{url('css/member-contribution.css')}}">
...
<aside class="sidebar" id="sidebar">
  <div class="brand"><img src="{{url('img/logo.png')}}" alt="logo">
    <div class="fw-bold">Kapunongan
    </div>
  </div>
  <nav>
    <a href="{{route('page.dashboard-member')}}">Dashboard</a>
    <a href="{{route('page.member-contribution')}}" class="active">Transactions</a>
