...
<nav class="navbar navbar-expand-lg sticky-top">
  <div class="container d-flex align-items-center">
    <a class="navbar-brand titles">
      <img src="{{url('img/logo.png')}}" alt="logo" style="height:34px;margin-right:10px;"> Kapunongan sa Dayong
    </a>  
...
<section id="about">
  <div class="container">
    ...
    <div class="row align-items-center mb-5 about-row">
      <div class="col-md-6">
        <div class="about-card glass-card p-0">
            <img src="{{url('img/SMCT-Brand-photos-53.webp')}}" alt="Community Gathering" class="img-fluid rounded about-img">
        </div>
      </div>
      <div class="col-md-6">
    ...
    <div class="row align-items-center flex-md-row-reverse about-row">
      <div class="col-md-6">
        <div class="about-card glass-card p-0">
              <img src="{{url('img/how-to-include-community-outreach-programs-in-your-nursing-home-1.jpg')}}" class="img-fluid rounded about-img">
        </div>
      </div>
      <div class="col-md-6">
    ...
    <div class="row mt-4">
      <div class="col-md-4 mb-4">
        <div class="glass-card membership-card text-center">
          <img src="{{url('img/discussion.png')}}" class="membership-icon mb-3" alt="discussion icon" style="width:64px;height:64px">
      ...
      <div class="col-md-4 mb-4 ">
        <div class="glass-card membership-card text-center ">
          <img src="{{url('img/community-building.png')}}" class="membership-icon mb-3" alt="community icon" style="width:64px;height:64px">
      ...
      <div class="col-md-4 mb-4">
        <div class="glass-card membership-card text-center">
          <img src="{{url('img/wreath.png')}}" class="membership-icon mb-3" alt="wreath icon" style="width:64px;height:64px">
...
<div class="modal fade" id="loginModal" tabindex="-1">
  ...
  <img src="{{url('img/hide.png')}}" class="toggle-password" data-target="loginPassword">
</div>
      ...
      <div class="mb-3">
        <label class="form-label">Password</label>
          <div class="password-wrapper">
            ...
            <img src="{{url('img/hide.png')}}" class="toggle-password" data-target="regPassword">
          </div>
      </div>
      <div class="mb-3">
        <label class="form-label">Confirm Password</label>
          <div class="password-wrapper">
            ...
            <img src="{{url('img/hide.png')}}" class="toggle-password" data-target="regConfirmPassword">
          </div>
      </div>
...
document.querySelectorAll(".toggle-password").forEach(icon => {
  icon.addEventListener("click", () => {
    ...
    if (input.type === "password") {
      input.type = "text";
        icon.src = "{{url('img/show.png')}}"; // replace with your show icon
    } else {
      input.type = "password";
      icon.src = "{{url('img/hide.png')}}"; // replace with your hide icon
    }
  });
});
</script>
