...
<link rel="stylesheet" href="<?php echo e(url('css/dashboard-member.css')); ?>">
...
<aside class="sidebar" id="sidebar">
  ...
  <nav>
    <a href="<?php echo e(route('page.dashboard-member')); ?>" class="active">Dashboard</a>
    <a href="<?php echo e(route('page.member-contribution')); ?>">Transactions</a>
  ...
  <main class="container py-4">
    ...
    <div class="card mb-4">
      <div class="card-body">
        ...
        <a href="<?php echo e(route('page.member-settings')); ?>" class="btn btn-accent">Go to Settings</a>
      </div>
    </div>
...
<div class="card mb-4">
  ...
  <div class="card-body" id="announcementsList">
    ...
    <?php $__empty_1 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
      <div class="announcement-item" id="announcement-<?php echo e($note->announcement_id); ?>">
        <!-- Dismiss Button (X) -->
        <button class="dismiss-btn" data-id="<?php echo e($note->announcement_id); ?>" title="Dismiss announcement">&times;</button>

        <div class="announcement-content">
          <strong><?php echo e($note->title); ?></strong>
          <small class="text-info"><?php echo e($note->date); ?></small><br>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function dismissAnnouncement(announcementId, button) {
        ...
        fetch('<?php echo e(route("announcements.dismiss")); ?>', {
            method: 'POST',
            headers: {
...
<?php /**PATH C:\xampp\htdocs\kapunongan\resources\views/page/dashboard-member.blade.php ENDPATH**/ ?>