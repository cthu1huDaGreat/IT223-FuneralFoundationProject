...
<link rel="stylesheet" href="<?php echo e(url('css/president-members.css')); ?>">
</head>
...
<aside class="sidebar" id="sidebar">
  ...
  <nav>
    <a href="<?php echo e(route('page.dashboard-president')); ?>">Dashboard</a>
    <a href="<?php echo e(route('page.president-contribution')); ?>">Transactions</a>
    <a href="<?php echo e(route('page.president-funeral')); ?>">Funeral Assistance</a>
    <a href="<?php echo e(route('page.president-members')); ?>" class="active">Manage Members</a>
        ...
        <div class="modal-body">
          ...
          <div class="mb-2">
            ...
            <div class="password-wrapper">
              ...
              <img src="<?php echo e(asset('img/hide.png')); ?>" class="toggle-password" data-target="Password">
            </div>
          </div>
          <div class="mb-2">
            ...
            <div class="password-wrapper">
              ...
              <img src="<?php echo e(asset('img/hide.png')); ?>" class="toggle-password" data-target="confirmPassword">
            </div>
          </div>
        </div>
        ...
        <div class="modal-body">
          ...
          <div class="mb-2">
            ...
            <div class="password-wrapper">
              ...
              <img src="<?php echo e(asset('img/hide.png')); ?>" class="toggle-password" data-target="editMemberPassword">
            </div>
          </div>
          <div class="mb-2">
            ...
            <div class="password-wrapper">
              ...
              <img src="<?php echo e(asset('img/hide.png')); ?>" class="toggle-password" data-target="editMemberConfirmPassword">
            </div>
          </div>
        </div>
...
function loadMembers() {
    ...
    fetch('<?php echo e(route("members.get")); ?>', {
        method: 'GET',
        headers: {
            'X-Requested-With': 'XMLHttpRequest',
            'Accept': 'application/json'
...
// Load roles function
function loadRoles() {
    fetch('<?php echo e(route("members.roles")); ?>', {
        method: 'GET',
        headers: {
            'X-Requested-With': 'XMLHttpRequest',
            'Accept': 'application/json'
...
function updateMember() {
    ...
    fetch('<?php echo e(route("members.update")); ?>', {
        method: 'POST',
        body: formData,
        headers: {
            'X-Requested-With': 'XMLHttpRequest',
...
function deleteMember(userId) {
    ...
    fetch('<?php echo e(route("members.delete")); ?>', {
        method: 'POST',
        headers: {
...
function debugMembers() {
    ...
    console.log('Routes:');
    console.log('- members.get: <?php echo e(route("members.get")); ?>');
    console.log('- members.update: <?php echo e(route("members.update")); ?>');
    console.log('==================');
}
...
function loadPendingRegistrations() {
    ...
    fetch('<?php echo e(route("users.pending")); ?>', {
        method: 'GET',
        headers: {
            'X-Requested-With': 'XMLHttpRequest',
            'Accept': 'application/json'
...
function approveUser(userId, button) {
    ...
    fetch('<?php echo e(route("users.approve")); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-Requested-With': 'XMLHttpRequest',
...
function deleteUser(userId, button) {
    ...
    fetch('<?php echo e(route("users.delete")); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-Requested-With': 'XMLHttpRequest',
...
document.querySelectorAll(".toggle-password").forEach(icon => {
  icon.addEventListener("click", () => {
    ...
    if (input.type === "password") {
      input.type = "text";
      icon.src = "<?php echo e(asset('img/show.png')); ?>"; 
    } else {
      input.type = "password";
      icon.src = "<?php echo e(asset('img/hide.png')); ?>";
    }
  });
});
...
</html><?php /**PATH C:\xampp\htdocs\kapunongan\resources\views/page/president-members.blade.php ENDPATH**/ ?>