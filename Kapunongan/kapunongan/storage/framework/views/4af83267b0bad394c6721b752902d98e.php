...
<link rel="stylesheet" href="<?php echo e(url('css/member-settings.css')); ?>">
...
<aside class="sidebar" id="sidebar">
  ...
  <nav>
    ...
    <a href="<?php echo e(route('page.member-settings')); ?>" class="active">Settings</a>
...
document.querySelectorAll(".toggle-password").forEach(icon => {
  icon.addEventListener("click", () => {
    ...
    if (input.type === "password") {
      input.type = "text";
      icon.src = "<?php echo e(url('img/show.png')); ?>";
    } else {
      input.type = "password";
      icon.src = "<?php echo e(url('img/hide.png')); ?>";
    }
  });
});
</script>
...
<?php /**PATH C:\xampp\htdocs\kapunongan\resources\views/page/member-settings.blade.php ENDPATH**/ ?>