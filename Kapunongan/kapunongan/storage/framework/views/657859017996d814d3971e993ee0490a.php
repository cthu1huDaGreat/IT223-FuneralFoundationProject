...
<link rel="stylesheet" href="<?php echo e(url('css/member-funeral.css')); ?>">
...
<img src="<?php echo e(url('img/logo.png')); ?>" alt="logo">
  ...
  <nav>
    ...
    <a href="<?php echo e(route('page.member-funeral')); ?>" class="active">Funeral Information</a>
...
<?php /**PATH C:\xampp\htdocs\kapunongan\resources\views/page/member-funeral.blade.php ENDPATH**/ ?>