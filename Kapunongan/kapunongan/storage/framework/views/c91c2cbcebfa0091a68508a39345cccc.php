...
<title>President Settings - Kapunongan</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
<link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css" rel="stylesheet">
  <link rel="icon" type="image/png" href="<?php echo e(url('img/logo.png')); ?>">
<link rel="stylesheet" href="<?php echo e(url('css/president-settings.css')); ?>">
...
<aside class="sidebar" id="sidebar">
  ...
  <nav>
    ...
    <a href="<?php echo e(route('page.president-settings')); ?>" class="active">Settings</a>
              ...
              <?php echo csrf_field(); ?>
                <div class="mb-3">
                  <label class="form-label fw-bold">Current Password</label>
                    <div class="password-wrapper">
                      ...
                      <img src="<?php echo e(url('img/hide.png')); ?>" class="toggle-password" data-target="currentPassword">
                    </div>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="password-wrapper">
                    ...
                    <img src="<?php echo e(url('img/hide.png')); ?>" class="toggle-password" data-target="newPassword">
                  </div>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="password-wrapper">
                    ...
                    <img src="<?php echo e(url('img/hide.png')); ?>" class="toggle-password" data-target="confirmPassword">
                  </div>
                </div>
                <button id="saveSettingsBtn" class="btn-save btn-accent">Save</button>
          </form><br>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('<?php echo e(route("family.list")); ?>', {
        method: 'GET',
        headers: {
    ...
    fetch('<?php echo e(route("family.store")); ?>', {
        method: 'POST',
        body: formData,
        headers: {
            'X-Requested-With': 'XMLHttpRequest',
    ...
    function deleteFamilyMember(id) {
        ...
        fetch('<?php echo e(route("family.delete")); ?>', {
            method: 'POST',
            headers: {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadProfileData() {
        fetch('<?php echo e(route("profile.get")); ?>', {
            method: 'GET',
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
                'Accept': 'application/json',
...
<?php /**PATH C:\xampp\htdocs\kapunongan\resources\views/page/president-settings.blade.php ENDPATH**/ ?>