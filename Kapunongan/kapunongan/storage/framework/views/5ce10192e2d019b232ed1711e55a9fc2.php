...
<title>President Funeral Assistance - Kapunongan</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
<link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css" rel="stylesheet">
  <link rel="icon" type="image/png" href="<?php echo e(url('img/logo.png')); ?>">

<link rel="stylesheet" href="<?php echo e(url('css/president-funeral.css')); ?>">
</head>
<body>
...
<aside class="sidebar" id="sidebar">
  ...
  <nav>
    ...
    <a href="<?php echo e(route('page.president-funeral')); ?>" class="active">Funeral Assistance</a>
...
<div class="page-content">
  ...
  <main class="container py-4">
    <h2 class="fw-bold mb-4">Funeral Assistance Overview</h2>
    ...
    <div class="row g-3 mb-4">
      <div class="col-md-4">
        <div class="card p-3">
          ...
          <h3 id="totalFuneral">₱0</h3>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card p-3">
          <h6 style="color: #00E5FF;">Members Paid</h6>
          <h3 id="membersClaimed">0/0</h3>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card p-3">
          <h6 style="color: #00E5FF;">Pending Claims</h6>
    ...
    <!-- Funeral Table -->
    <div class="card mb-4">
       <div class="card-header">Funeral Table</div>
      <div class="card-body table-responsive">
        ...
        <table class="table table-dark table-hover align-middle">
          ...
          <tbody id="funeralTableBody"></tbody>
        </table>
      </div>
    </div>
  </main>
...
<?php /**PATH C:\xampp\htdocs\kapunongan\resources\views/page/treasurer-funeral.blade.php ENDPATH**/ ?>