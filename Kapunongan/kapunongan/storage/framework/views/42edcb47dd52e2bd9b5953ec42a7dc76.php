    ...
    <div class="row g-3 mb-4">
      <div class="col-md-4">
        <div class="card shadow-sm p-3">
            ...
            <h3 id="totalBalance">₱<?php echo e(number_format($totalBalance ?? 0, 2)); ?></h3>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card shadow-sm p-3">
        ...
        <div class="announcement-item" id="announcement-<?php echo e($note->announcement_id); ?>">
          <div class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item text-danger delete-announcement" href="#" data-id="<?php echo e($note->announcement_id); ?>">Delete</a></li>
            </ul>
          </div>
  ...
  <div class="card-body">
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <div class="text-end">
        ...
        <h3 class="mb-0" id="totalMembers"><?php echo e($totalMembers); ?></h3>  
      </div>
    </div>
    <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('confirmDeleteAnnouncementBtn').addEventListener('click', function() {
        ...
        fetch('<?php echo e(route("announcements.delete")); ?>', {
            method: 'POST',
            headers: {
...
<?php /**PATH C:\xampp\htdocs\kapunongan\resources\views/page/dashboard-president.blade.php ENDPATH**/ ?>