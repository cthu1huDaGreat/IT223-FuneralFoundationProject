...
<link rel="stylesheet" href="<?php echo e(url('css/treasurer-contributions.css')); ?>">
...
<img src="<?php echo e(url('img/logo.png')); ?>" alt="logo">  
 <div class="fw-bold">Kapunongan</div></div>
  <nav>
    ...
    <a href="<?php echo e(route('page.treasurer-contributions')); ?>" class="active">Transactions</a>
...
<?php /**PATH C:\xampp\htdocs\kapunongan\resources\views/page/treasurer-contributions.blade.php ENDPATH**/ ?>